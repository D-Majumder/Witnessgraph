"""python -m research.wg_bench.v2 [--out-dir DIR]

Runs WG-Bench V2 end-to-end and prints a human-readable summary to
...
otherwise -- independent of any method's false-corroboration results,
which are permanent experimental findings, not pass/fail conditions.
"""
...
from research.wg_bench.v2.runner import render_text_report, run_benchmark, to_json_document
from witnessgraph.core.ids import canonical_json_bytes


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="python -m research.wg_bench.v2")
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=None,
